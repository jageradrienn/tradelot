<template>
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            stroke="#B3AEFF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M11.8901 5.0498C12.3201 7.8098 14.5601 9.9198 17.3401 10.1998" stroke="#B3AEFF" stroke-width="1.5"
            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M3 22H21" stroke="#B3AEFF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
